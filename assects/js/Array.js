const db = [
    ...
    },
    {
      ...
      dateOpen: "2011-02-09",
      description:
        "Sparrow was an email client for OS X and iOS. They acquired and then killed it.",
    ...
    },
    {
      ...
      dateOpen: "2003-11-10",
      description:
        "Google Deskbar was a small inset window on the Windows toolbar and lets users perform searches without leaving desktop.",
      link:
        "https://www.computerweekly.com/news/2240053391/Google-launches-Deskbar-software",
      name: "Google Deskbar",
      type: "service"
    },
    {
    ...
    },
    {
      ...
      link:
        "https://gsuite-developers.googleblog.com/2015/08/deprecating-web-hosting-support-in.html",
    ...
    },
    {
      ...
      link:
        "https://en.wikipedia.org/wiki/Google_Search#Dedicated_encrypted_search_page",
    ...
    },
    {
      ...
      dateOpen: "2005-10-23",
      description:
        "Panoramio was geo-located tagging, photo sharing mashup product.",
    ...
    },
    {
      ...
      dateOpen: "2013-11-15",
      description:
        "Google Helpouts was an online collaboration service where users to share their expertise through live video.",
    ...
    },
    {
      ...
      dateOpen: "2007-06-28",
      description:
        "Google Questions and Answers was a free knowledge market that allowed users to collaboratively find good answers to their questions.",
    ...
    {
      dateClose: "2014-01-06",
      dateOpen: "2013-09-19",
      description:
        "Quickoffice was a productivity suite for mobile devices which allowed viewing, creating and editing documents, presentations and spreadsheets.",
    ...
    },
    {
      ...
      dateOpen: "2005-01-01",
      description:
        "Google Notifier alerted users to new messages in their Gmail account.",
      link:
        "https://www.theverge.com/2014/1/16/5316748/google-quietly-kills-off-its-notifier-service-for-mail-and-calendar",
    ...
    },
    {
      ...
      dateOpen: "2007-12-06",
      description:
        "Google Chart API was an interactive Web service that creates graphical charts from user-supplied data.",
    ...
    },
    {
      ...
      dateOpen: "2009-12-01",
      description:
        "Google URL Shortener, also known as goo.gl, is a URL shortening service.",
    ...
    },
    {
      ...
      dateOpen: "2008-01-01",
      description:
        "Google Desktop allowed local searches of user's email messages, computer files, music, photos, chats, Web pages viewed.",
    ...
    },
    {
      ...
      dateOpen: "2010-12-06",
      description:
        "Google Chrome Apps were a hosted or packaged web application that ran on the Google Chrome browser.",
    ...
    },
    {
      ...
      dateOpen: "2002-01-01",
      description:
        "Google Public Service search provided government, non-profits, and academic organizations search results without ads.",
      link:
        "https://webmasters.googleblog.com/2006/09/for-those-wondering-about-public.html",
    ...
    },
    {
      ...
      link:
        "https://www.hexus.net/tech/news/software/4324-google-video-marketplace/",
    ...
    },
    {
      ...
      link:
        "https://techcrunch.com/2008/11/24/why-did-google-discontinue-searchmash/",
      name: "SearchMash",
      type: "service"
    },
    {
    ...
    },
    {
      ...
      link:
        "https://searchenginewatch.com/sew/news/2062429/new-from-google-labs-google-ride-finder#",
    ...
    },
    {
      ...
      link:
        "https://techcrunch.com/2016/11/07/google-quietly-shutters-standalone-google-showtimes-movie-site/",
    ...
    },
    {
      ...
      dateOpen: "2014-05-01",
      description:
        "Google Play was an edition of an Android phone that Google sold.",
      link:
        "https://arstechnica.com/gadgets/2015/01/dont-cry-for-the-google-play-edition-program-it-was-already-dead/",
      name: "Google Play",
      type: "hardware"
    },
    {
      ...
      link:
        "https://www.gadgetsnow.com/year-in-review-2016/Google-Compare/yearendershow2016/55617272.cms",
      name: "Google Compare",
      type: "service"
    },
    {
    ...
    },
    {
      ...
      dateOpen: "2012-06-27",
      description:
        "Nexus Q was a digital media player that allowed users to stream content from supported services to a connected television.",
    ...
    },
    {
      ...
      dateOpen: "2010-01-01",
      description:
        "Google X was an American semi-secret research & development organization which now operates as a subsidiary of Alphabet Inc.",
    ...
    },
    {
      ...
      dateOpen: "2005-08-22",
      description:
        "Often remembered as 'Gchat', Google Talk was a messaging service for both text and voice using XMPP. Google later replaced Google Talk with Hangouts.",
    ...
    },
    {
      ...
      dateOpen: "2013-04-15",
      description:
        "Google Glass was a wearable computer with an optical head-mounted display and camera that allows the wearer to interact with various applications and the Internet via natural language voice commands. Glass now only lives on as Enterprise Product.",
    ...
    },
    {
      ...
      link:
        "https://googleblog.blogspot.com/2012/08/giving-you-better-google.html",
      name: "Google Listen",
      type: "app"
    },
    {
    ...
    },
    {
      ...
      dateOpen: "2013-06-01",
      description:
        "Pie was a work-centric groupchat website and app comparable to Slack.",
    ...
    },
    {
      ...
      link:
        "https://maps.googleblog.com/2011/01/retiring-real-estate-on-google-maps.html",
    ...
    },
    {
      ...
      link: "https://en.wikipedia.org/wiki/Google_Cloud_Connect",
      name: "Google Cloud Connect",
      type: "service"
    },
    {
      dateClose: "2013-05-10",
      dateOpen: "2004-10-01",
      description:
      ...
      link: "https://techcrunch.com/2013/05/12/google-kills-sms-search/",
      name: "Google SMS",
      type: "service"
    },
    {
      dateClose: "2016-09-12",
      dateOpen: "2012-01-01",
      description:
        "Google Hangouts On Air — Google's live-streaming service — has moved to YouTube Live in September 2016. The service was originally created in 2012 when live-streaming was catching on and was once used by President Obama and Pope Francis.",
      link:
        "https://www.engadget.com/2012/05/08/google-lets-you-broadcast-your-hangouts/",
      name: "Google Hangouts On Air",
      type: "service"
    },
    {
      dateClose: "2018-10-16",
      dateOpen: "2016-09-12",
      description:
        "Google News & Weather is a news aggregator application developed by Google. On May 8, 2018, Google announced that it was merging Google Play Newsstand and Google News & Weather into a single service, called Google News. It was available on the Android and iOS operating systems.",
      link: "https://en.wikipedia.org/wiki/Google_News_%26_Weather",
      name: "Google News & Weather",
      type: "app"
    },
    {
      dateClose: "2011-07-01",
      dateOpen: "2009-11-01",
      description:
      ...
      link: "https://en.wikipedia.org/wiki/Google_Script_Converter",
      name: "Google Script Converter",
      type: "service"
    },
    {
      dateClose: "2012-08-20",
      dateOpen: "2005-01-25",
      description:
      ...
      link: "https://en.wikipedia.org/wiki/Google_Video",
      name: "Google Video",
      type: "service"
    },
    {
      dateClose: "2011-10-13",
      dateOpen: "2010-12-15",
      description:
      ...
      link: "https://en.wikipedia.org/wiki/ZygoteBody",
      name: "ZygoteBody",
      type: "service"
    },
    {
    ...
    },
    {
      ...
      link:
        "https://mangomap.com/blog/the-end-of-google-maps-engine-causes-mass-confusion/",
      name: "Google Maps Engine",
      type: "service"
    },
    {
      dateClose: "2018-08-15",
      dateOpen: "2016-04-14",
      description:
        "Save to Google Chrome Extension enabled you to quickly save a page link with image and tags to a Pocket-like app.",
      link:
        "https://9to5google.com/2018/07/22/google-kills-save-to-google-chrome-material-theme/",
    ...
    },
    {
      ...
      link:
        "https://googleblog.blogspot.com/2012/04/spring-cleaning-in-spring.html",
    ...
    },
    {
      ...
      link: "https://en.wikipedia.org/wiki/Google_Image_Swirl",
      name: "Google Image Swirl",
      type: "service"
    },
    {
      dateClose: "2017-02-08",
      dateOpen: "2016-03-02",
      description:
        "Google Hands Free was a mobile payment system that allowed users to pay their bill by simply saying 'I'll pay with Google.' It used Bluetooth to wirelessly connect to payment terminals, and that longer range meant that you could keep your phone in your pocket.",
      link:
        "https://www.slashgear.com/google-shutting-down-hands-free-next-week-02473609/",
      name: "Google Hands Free",
      type: "service"
    },
    {
      dateClose: "2016-05-02",
      dateOpen: "2007-03-03",
      description:
      ...
      link: "https://en.wikipedia.org/wiki/Freebase",
      name: "Freebase",
      type: "service"
    },
    {
      dateClose: "2014-03-14",
      dateOpen: "2012-07-31",
      description:
    ...
    },
    {
      ...
      dateOpen: "2012-07-09",
      description:
        "Google Now was a feature of Google Search that offered predictive cards with information and daily updates in the Google app for Android and iOS.",
      link: "https://en.wikipedia.org/wiki/Google_Now",
      name: "Google Now",
      type: "service"
    },
    {
      dateClose: "2015-08-20",
      dateOpen: "2008-11-01",
      description:
        "Google Flu Trends was a service attempting to make accurate predictions about flu activity. ",
      link: "https://en.wikipedia.org/wiki/Google_Flu_Trends",
    ...
    },
    {
      ...
      link: "https://en.wikipedia.org/wiki/Urchin_(software)",
      name: "Urchin",
      type: "service"
    },
    {
      ...
      dateOpen: "2013-02-21",
      description:
        "Chromebook Pixel was a high-end Chromebook laptop mixing Chrome OS with an Intel i5, 4GB DDR3 RAM, a 32GB SSD, and a 2,560x1,700 12.85in screen.",
      link: "https://en.wikipedia.org/wiki/Chromebook_Pixel",
      name: "Chromebook Pixel",
      type: "hardware"
    },
    {
      dateClose: "2007-08-17",
      dateOpen: "2006-08-22",
      description:
      ...
      link: "https://en.wikipedia.org/wiki/Google_Video#Google_Video_Player",
      name: "Google Video Player",
      type: "service"
    },
    {
      dateClose: "2018-04-10",
      dateOpen: "2010-07-01",
      description:
      ...
      link: "https://developers.google.com/qpx-express/",
      name: "qpx-express-API",
      type: "service"
    },
    {
      dateClose: "2016-01-31",
      dateOpen: "2007-11-08",
      description:
      ...
      link: "https://en.wikipedia.org/wiki/Songza",
      name: "Songza",
      type: "service"
    },
    {
      dateClose: "2014-02-01",
      dateOpen: "2010-09-22",
      description:
      ...
      link: "https://en.wikipedia.org/wiki/Google_Chrome_Frame",
    ...
    },
    {
      ...
      dateOpen: "2009-05-12",
      description:
        "Google Sky Map was an augmented reality star mapping application for Android devices.",
    ...
    },
    {
      ...
      link:
        "https://www.huffingtonpost.com/rory-oconnor/apture-web-30-is-now_b_161608.html",
      name: "Apture",
      type: "service"
    },
    {
      ...
      link: "https://en.wikipedia.org/wiki/Fflick",
      name: "fflick",
      type: "service"
    },
    {
      dateClose: "2014-06-30",
      dateOpen: "2010-10-06",
      description:
    ...
    },
    {
      ...
      link:
        "https://web.archive.org/web/20021105033319/http://www.google.com/apis/",
